...
use ade_core::git::GitOps;
use ade_core::line_comments::{
    build_comment_prompt, CommentPromptContext, LineComment, SourceSide,
};
use ade_core::tasks::operations::{InitialConversationConfig, TaskConfigParams};
use tauri::State;
...
pub struct CreateTaskFromCommentResult {
    pub task: ade_core::tasks::TaskDto,
    pub prompt: String,
}
