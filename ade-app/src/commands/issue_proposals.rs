...
use ade_core::issue_proposal::{apply_proposal, parse_proposal, Proposal};
use ade_core::issues::Issue;

use crate::app::App;

/// Validates a raw ```ade-proposal block payload. Err = the frontend
