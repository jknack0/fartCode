...
use ade_app_lib::dispatch::{flip_issues_for_task, issue_dispatch_core};
use ade_app_lib::terminals::{TerminalManager, TerminalSpec};
use ade_core::issues::{Lane, NewIssue};
use ade_core::projects::ProjectStore;
use ade_core::settings::{LocalProjectGroup, LOCAL_PROJECT};
...
impl Fixture {
    fn new_issue(&self, title: &str) -> ade_core::issues::Issue {
        self.app
            .issues
            .create(NewIssue {
