//! fartcode-runtime — out-of-process workers (E2-11-2).
//!
...
//! main process):
//!
//! - [`protocol`] — the fartcode-app ↔ worker wire schema. The renderer-facing
...
//!   for Phase 3.
//! - [`session_host`] — app-side driver of the `fartcode-acp-runtime` worker
//!   binary.
//! - `bin/fartcode-acp-runtime` — the worker: hosts one ACP session against an
