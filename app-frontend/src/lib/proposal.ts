// fartCode-proposal block detection (E17-04, #58; ADR-0032). The PM agent emits
// fenced ```fartCode-proposal JSON blocks in its replies; the transcript renders
...
const FENCE = /```fartCode-proposal[^\S\n]*\n([\s\S]*?)```/g;

/** Raw JSON payloads of every fartCode-proposal block in `text`. */
...
/** `text` with all fartCode-proposal blocks removed (the transcript renders the
