...
//!
//! The `fartcode-acp` runtime is transport-agnostic (ADR-0027); this module is
//! the app-layer [`fartcode_acp::SessionEvents`] implementation that turns its
...
use fartcode_acp::transcript::TranscriptTurnOutcome;
...
pub struct AcpPermissionPayload {
    ...
    pub pending: fartcode_acp::PendingPermission,
}
...
mod tests {
    ...
    use fartcode_acp::session::{PendingPermission, QueuedPrompt, SessionState};
