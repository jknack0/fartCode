...
use ade_core::dependencies::host_dependency::{host_dependency, InstallPlan, InstallType};
use ade_core::dependencies::{
...
fn process_runner_survives_a_large_stderr_flood() {
    ...
    // drain must complete.
    use ade_core::dependencies::{InstallRunner, ProcessInstallRunner};
