...
///
/// Implemented over `fartcode_core::conversations::ConversationStore` at the app
/// layer (#32); kept trait-shaped here so `fartcode-acp` stays free of the
/// fartcode-core dependency (ADR-0027).
