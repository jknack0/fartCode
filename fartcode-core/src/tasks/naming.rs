...
mod tests {
    ...
    fn branch_name_prefix_and_suffix() {
        ...
        assert_eq!(
            resolve_task_branch_name(&opts),
            "fartCode/fix-auth-bug-abc12"
        );
        ...
        assert_eq!(
            resolve_task_branch_name(&no_suffix),
            "fartCode/fix-auth-bug"
        );
        ...
        assert_eq!(resolve_task_branch_name(&disabled), "fartCode/fix-auth-bug");
    }
    ...
    fn linear_issue_branch_is_verbatim() {
        ...
        assert_eq!(resolve_task_branch_name(&opts), "fartCode/fix-auth-bug");
    }

    #[test]
    fn prefix_normalized() {
        assert_eq!(normalize_branch_prefix("  fartCode  "), "fartCode");
        assert_eq!(normalize_branch_prefix("/team/fartCode/"), "team/fartCode");
        assert_eq!(normalize_branch_prefix("/fartCode"), "fartCode");
    }
